      ...
      <div className={styles.divcontainer}>
        ...
        <section className={styles.firstsection}>
          <div className={styles.membercards}>
            ...
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/173044695?v=4" alt="" />
            <p>Game Developer</p>
            ...
            <a className={styles.socialnetwork} href='https://www.linkedin.com/in/luna-dessauvage/' target='blank'>
          ...
          <div className={styles.membercards}>
            ...
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/172907888?v=4" alt="" />
            <p>Game Developer</p>
            <p className={styles.ph4}>PhaserJS</p>
          ...
          <div className={styles.membercards}>
            ...
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/90244248?v=4" alt="" />
            <p>Graphist</p>
            ...
            <a className={styles.socialnetwork} href='https://www.linkedin.com/in/gweny-dos-santos/' target='blank'>
              <img src='/src/assets/Icons/linkedin-logo.svg' alt='LinkedIn Profile' />
            </a>
          </div>
          ...
          <div className={styles.membercards}>
            ...
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/80418872?v=4" alt="" />
            <p>Project Chief</p>
            <p>Git Referent</p>
          ...
          <div className={styles.membercards}>
            ...
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/165404920?v=4" alt="" />
          ...
          <div className={styles.membercards}>
            <h3>Sounia Mhalla</h3>
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/166948925?v=4" alt="" />
            <p>Frontend Developer </p>
            <p className={styles.ph4}>React</p>
          ...
          <div className={styles.membercards}>
            <h3>Ines Troye</h3>
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/183735662?v=4" alt="" />
          ...
          <div className={styles.membercards}>
            <h3>Anissa</h3>
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/83823625?v=4" alt="" />
            <p>Admin System and Network</p>
          ...
          <div className={styles.membercards}>
            <h3>Audrey</h3>
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/83540368?v=4" alt="" />
            <h4>UI/UX</h4>
          ...
          <div className={styles.membercards}>
            <h3>Wissal</h3>
            <img className={styles.profilImage} src="https://avatars.githubusercontent.com/u/8382869?v=4" alt="" />
            <h4>UI/UX</h4>
            <p className={styles.ph4}>Figma</p>
          </div>
          ...
          <footer>
            <p>
              This project has been developed during the Hackathon 2024 directed by Interface3.
            </p>
            <p>
              Special thanks to Sonia, Nicole, Ellis, Bastien, Samuel, Gavin & Joel.
            </p>
          </footer>
        </section>
      </div>
